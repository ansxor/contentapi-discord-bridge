...
func TestGetAttachmentStreamSupportedFileTypeAndFileSize(t *testing.T) {
	_, err := GetAttachmentStream("https://smilebasicsource.com/contentapi/images/raw/cnvsbs-upload-1229")
...
func TestGetAttachmentStreamIncorrectFileType(t *testing.T) {
	_, err := GetAttachmentStream("https://smilebasicsource.com")
...
func TestGetAttachmentStreamIncorrectFileSize(t *testing.T) {
	_, err := GetAttachmentStream("https://eoimages.gsfc.nasa.gov/images/imagerecords/73000/73751/world.topo.bathy.200407.3x21600x21600.C1.png")
